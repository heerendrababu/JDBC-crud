...
public class StudentServices 
{
  ...
  //Reading and displaying in Console.
  public static void reading()
  {
	try
	{
		...
		String qry = "select * from student50 where sname = ('giri')";
  ...
  public static void inserting(String name,String sub,String email)
  {
	  try 
		{
			cn = myConnection();
			String qry = "insert into student50(sname,sub,email)values(?,?,?)";
            ps = cn.prepareStatement(qry);
  ...
  public static void creating() // it is public because we need to call it in another package.
  {
	try 
	{
		...
		String qry = "create table student50(sno int primary key auto_increment,sname varchar(40),sub varchar(40),email varchar(40) unique)";
